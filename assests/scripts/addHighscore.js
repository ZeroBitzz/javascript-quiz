...
export function addHighscore(){
    ...
    if(endScore === 0){
        ...
        if(localStorage.getItem('scoreEntered') === 'no'){
            if(score1 < endScore || ((score1 === endScore) && (Number(localStorage.getItem('time1')) <= playerTime))){
            ...
            }else if(score2 < endScore || ((score2 === endScore) && (Number(localStorage.getItem('time2')) <= playerTime))){
                localStorage.setItem('score5', localStorage.getItem('score4'))
                localStorage.setItem('time5', localStorage.getItem('time4'))
                localStorage.setItem('initials5', localStorage.getItem('initials4'))
                highscoreElm5.innerHTML = `#5 - ${localStorage.getItem('initials5')} / score: ${localStorage.getItem('score5')} / time left: ${localStorage.getItem('time5')} seconds`
            ...
            }else if(score3 < endScore || ((score3 === endScore) && (Number(localStorage.getItem('time3')) <= playerTime))){
                localStorage.setItem('score5', localStorage.getItem('score4'))
                localStorage.setItem('time5', localStorage.getItem('time4'))
                localStorage.setItem('initials5', localStorage.getItem('initials4'))
                highscoreElm5.innerHTML = `#5 - ${localStorage.getItem('initials5')} / score: ${localStorage.getItem('score5')} / time left: ${localStorage.getItem('time5')} seconds`
            ...
            }else if(score4 < endScore || ((score4 === endScore) && (Number(localStorage.getItem('time4')) <= playerTime))){
                localStorage.setItem('score5', localStorage.getItem('score4'))
                localStorage.setItem('time5', localStorage.getItem('time4'))
                localStorage.setItem('initials5', localStorage.getItem('initials4'))
                highscoreElm5.innerHTML = `#5 - ${localStorage.getItem('initials5')} / score: ${localStorage.getItem('score5')} / time left: ${localStorage.getItem('time5')} seconds`
            ...
            else if(score5 < endScore || ((score4 === endScore) && (Number(localStorage.getItem('time5')) <= playerTime))){
